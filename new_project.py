...
""")
    ...
    def get_weather(self):
        api_key="fe3a0d9e5cf58dc89401ccfd29b62fbe"
    ...
    def display_weather(self,data):
        ...
        description_label=data["weather"][0]["description"]
        weather_id=data["weather"][0]["id"]
        self.temperature_label.setText(f"{temperature_f:.0f}℉")  #.0f = no decimal place.
        self.emoji.setText(self.get_weather_emoji(weather_id))
        self.description_label.setText(description_label)
